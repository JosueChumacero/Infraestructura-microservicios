 ...
 */
@Data
@Schema(name = "FacturaResponse", description = "modelo que representa a factura")
public class FacturaResponse {
    
    @Schema(name = "id", required = true, example = "2",defaultValue = "1", description = "clave unica que representa la factura")
    private long id;
